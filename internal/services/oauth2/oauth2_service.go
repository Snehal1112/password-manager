...
CreateClient(ctx context.Context, name, description string) (*domain.OAuth2Client, string, error)
...
tokenStr, err := s.jwtSvc.GenerateToken(client.ID, client.Name, "service_account")
if err != nil {
...
func (s *oauth2Service) CreateClient(ctx context.Context, name, description string) (*domain.OAuth2Client, string, error) {
