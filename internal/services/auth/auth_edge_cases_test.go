...
// ---------------------------------------------------------------------------
// legacyJWTService (NewJWTService — HS256 path)
// ---------------------------------------------------------------------------

func TestLegacyJWTService_ParseToken(t *testing.T) {
	t.Parallel()
...
func TestLegacyJWTService_ParseToken_MalformedToken(t *testing.T) {
	t.Parallel()
	svc := NewJWTService(JWTConfig{
		SecretKey: "test-secret-key-that-is-long-enough",
		Issuer:    "rocketvault",
...
func TestLegacyJWTService_ValidateToken_WrongIssuer(t *testing.T) {
	t.Parallel()
	signer := NewJWTService(JWTConfig{
		SecretKey: "test-secret-key-that-is-long-enough",
		Issuer:    "other-issuer",
		Audience:  "PASSWORD_MANAGER",
		Expiry:    time.Hour,
	})
	validator := NewJWTService(JWTConfig{
		SecretKey: "test-secret-key-that-is-long-enough",
		Issuer:    "rocketvault",
		Audience:  "PASSWORD_MANAGER",
		Expiry:    time.Hour,
...
func TestLegacyJWTService_ValidateToken_WrongAudience(t *testing.T) {
	t.Parallel()
	signer := NewJWTService(JWTConfig{
		SecretKey: "test-secret-key-that-is-long-enough",
		Issuer:    "rocketvault",
...
func TestLegacyJWTService_ValidateToken_WrongSigningKey(t *testing.T) {
	t.Parallel()
	signer := NewJWTService(JWTConfig{
		SecretKey: "signing-key-aaaaaaaaaaaaaaaaaaaaa",
		Issuer:    "rocketvault",
		Audience:  "PASSWORD_MANAGER",
		Expiry:    time.Hour,
	})
	validator := NewJWTService(JWTConfig{
		SecretKey: "different-key-bbbbbbbbbbbbbbbbbbb",
		Issuer:    "rocketvault",
		Audience:  "PASSWORD_MANAGER",
		Expiry:    time.Hour,
	})
