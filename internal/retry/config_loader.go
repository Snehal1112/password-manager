...
func BindRetryConfig(v *viper.Viper) {
	...
	v.BindEnv("retry.database.enabled", "RETRY_DATABASE_ENABLED")
	v.BindEnv("retry.database.max_attempts", "RETRY_DATABASE_MAX_ATTEMPTS")
	v.BindEnv("retry.database.initial_delay", "RETRY_DATABASE_INITIAL_DELAY")
	v.BindEnv("retry.database.max_delay", "RETRY_DATABASE_MAX_DELAY")
	v.BindEnv("retry.database.backoff_multiplier", "RETRY_DATABASE_BACKOFF_MULTIPLIER")
	v.BindEnv("retry.database.jitter_enabled", "RETRY_DATABASE_JITTER_ENABLED")

	// Bind external services retry configuration
	v.BindEnv("retry.external_services.enabled", "RETRY_EXTERNAL_SERVICES_ENABLED")
	v.BindEnv("retry.external_services.max_attempts", "RETRY_EXTERNAL_SERVICES_MAX_ATTEMPTS")
	v.BindEnv("retry.external_services.initial_delay", "RETRY_EXTERNAL_SERVICES_INITIAL_DELAY")
	v.BindEnv("retry.external_services.max_delay", "RETRY_EXTERNAL_SERVICES_MAX_DELAY")
	v.BindEnv("retry.external_services.backoff_multiplier", "RETRY_EXTERNAL_SERVICES_BACKOFF_MULTIPLIER")
	v.BindEnv("retry.external_services.jitter_enabled", "RETRY_EXTERNAL_SERVICES_JITTER_ENABLED")

	// Bind service operations retry configuration
	v.BindEnv("retry.service_operations.enabled", "RETRY_SERVICE_OPERATIONS_ENABLED")
	v.BindEnv("retry.service_operations.max_attempts", "RETRY_SERVICE_OPERATIONS_MAX_ATTEMPTS")
	v.BindEnv("retry.service_operations.initial_delay", "RETRY_SERVICE_OPERATIONS_INITIAL_DELAY")
	v.BindEnv("retry.service_operations.max_delay", "RETRY_SERVICE_OPERATIONS_MAX_DELAY")
	v.BindEnv("retry.service_operations.backoff_multiplier", "RETRY_SERVICE_OPERATIONS_BACKOFF_MULTIPLIER")
	v.BindEnv("retry.service_operations.jitter_enabled", "RETRY_SERVICE_OPERATIONS_JITTER_ENABLED")

	// Bind circuit breaker configuration
	v.BindEnv("retry.circuit_breaker.failure_threshold", "RETRY_CIRCUIT_BREAKER_FAILURE_THRESHOLD")
	v.BindEnv("retry.circuit_breaker.timeout", "RETRY_CIRCUIT_BREAKER_TIMEOUT")
	v.BindEnv("retry.circuit_breaker.half_open_requests", "RETRY_CIRCUIT_BREAKER_HALF_OPEN_REQUESTS")
}
